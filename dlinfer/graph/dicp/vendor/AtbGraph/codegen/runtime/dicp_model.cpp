...
void DICPModel::ExecuteOut(std::vector<torch::Tensor> atInTensors,
...
TORCH_LIBRARY(DICPModel, m) {
    m.class_<DICPModel>("DICPModel")
        .def(torch::init<std::string>())
        .def("execute_out", &DICPModel::ExecuteOut);
}
