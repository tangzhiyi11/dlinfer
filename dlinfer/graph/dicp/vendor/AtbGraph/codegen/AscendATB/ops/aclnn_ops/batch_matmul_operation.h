...
class AclNnBatchMatMulOperation : public AclNnOperation {
 public:
  explicit AclNnBatchMatMulOperation(const std::string& name,
                                     int8_t cubeMathType);
...
inline atb::Operation* AclNnBatchMatMulOperationCreate(
  ...
  DICP_LOG(INFO) << "AclNnBatchMatMulOperation: name: " << opName
